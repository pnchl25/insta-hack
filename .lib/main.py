...
def banner():
		print(f"""{cy}
  _         _            _            _
 (_)_ _  __| |_ __ _ ___| |_  __ _ __| |__
 | | ' \(_-<  _/ _` |___| ' \/ _` / _| / /
 |_|_||_/__/\__\__,_|   |_||_\__,_\__|_\_\{cy}


        {gr}Code By : {gr}HackerSM9{nu}
	            """)

useragent = [ 'Mozilla/5.0 (Linux; Android 10; Redmi Note 7 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36',
